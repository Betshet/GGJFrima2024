...
#include "Decorator_NeedItem.generated.h"
 ...
 * 
 */
UCLASS( BlueprintType, EditInlineNew, ClassGroup=("Dialogue"), AutoExpandCategories=("Dialogue"), DisplayName="Need Item to Activate")
class GGJFRIMA2024_API UDecorator_NeedItem : public UMounteaDialogueDecoratorBase
{
	GENERATED_BODY()
